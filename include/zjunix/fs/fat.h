...
unsigned long fs_find(FILE *file);//done

unsigned long init_fs();//done

unsigned long fs_open(FILE *file, unsigned char *filename);//done

unsigned long fs_close(FILE *file);//done

unsigned long fs_read(FILE *file, unsigned char *buf, unsigned long count);//done

unsigned long fs_write(FILE *file, const unsigned char *buf, unsigned long count);//done

unsigned long fs_fflush();//done

void fs_lseek(FILE *file, unsigned long new_loc);//done

unsigned long fs_create(unsigned char *filename);//done
